...
class EditIngredientValidationTest extends ValidationTestCase
{
    ...
    #[DataProviderExternal(ValidationDataProvider::class, 'validEditIngredientValues')]
    public function itAcceptsValidData(array $data): void
    {
        ...
        $this->editIngredientValidation->getDto();
